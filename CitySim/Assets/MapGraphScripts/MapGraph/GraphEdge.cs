...
public class GraphEdge
{
    ...
    // Replaces end of edge with new node and recalculates distance
    public void ReplaceEnd(GraphNode newNode)
    {
        end = newNode;
        CalculateDistance(start, end);
        CalculateAngle(start, end);
    ...
    private void CalculateAngle(GraphNode n1, GraphNode n2)
    {
        angle = Vector3.Angle(n1.position,n2.position);
    }
